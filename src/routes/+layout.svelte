		...
		<div class="container">
			<div class="app-nav__header">
				<a
					...
					href="https://github.com/rodrigodagostino/svelte-draggable-drawer"
					target="_blank"
				>
				...
				<a
					class="link link--npm"
					href="https://www.npmjs.com/package/@rodrigodagostino/svelte-draggable-drawer"
					target="_blank"
				>
					<span class="sr-only">Visit the NPM package</span>
					<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
						<path d="M0 0v24h24V0Zm4.5 4.5h15v15h-3v-12H12v12H4.5Z" />
					</svg>
				</a>
			</div>
			<hr class="separator" />
							...
							<td>
								...
								{:else if type === 'textarea'}
									<textarea
										...
										oninput={handleFieldChange}></textarea>
								{:else if type === 'select'}
...
<style>
	...
	.app-nav {
		...
		background-color: var(--sdd-gray-500);
		border-radius: 0.25rem;
		box-shadow: var(--sdd-box-shadow-4);
		position: fixed;
		top: 0.75rem;
		right: 0.75rem;
		z-index: 10020;
	...
	.app-controls {
		...
		background-color: var(--sdd-white);
		border-radius: 0.25rem;
		box-shadow: var(--sdd-box-shadow-4);
		position: fixed;
		right: 0.75rem;
		...
		& tr:nth-child(odd) td {
			background-color: var(--sdd-gray-100);
		}
		...
		& th {
			border-bottom: 1px solid var(--sdd-gray-200);
			text-align: start;
